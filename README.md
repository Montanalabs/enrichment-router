...
- `enrichment-router_safe.wave` — the correct design.
- `enrichment-router_unsafe.wave` — the tempting-but-wrong version (the negative example a model must learn to reject).
