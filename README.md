...
- `enrichment-router_safe.os` — the correct design.
- `enrichment-router_unsafe.os` — the tempting-but-wrong version (the negative example a model must learn to reject).
